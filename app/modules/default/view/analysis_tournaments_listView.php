...
<div class="content-wrapper">
    <section class="content pt-4">
        <div class="container-fluid mb-5">
            ...
            <div class="deep-dive-header mb-4 d-flex justify-content-between align-items-center flex-wrap">
                <div class="d-flex flex-column pe-3">
                    <h2 class="m-0 fw-bold fs-4 fs-md-3 text-truncate">
                        <i class="fas fa-chart-pie text-info me-2"></i> <?= __('tournament_analytics_title') ?>
                    </h2>
                    <div class="mt-2">
                ...
                <div class="row g-4">
                    <?php foreach ($data['tournaments'] as $event): ?>
                        <div class="col-12 col-md-6 col-xl-4 mb-3">
                            <a href="/default/analysis_tournament/<?= htmlspecialchars($event['key']) ?>" class="text-decoration-none text-dark d-block h-100">
                                <div class="card h-100 tournament-card shadow-sm bg-white">
                                    ...
                                    <div class="card-footer bg-light border-0 text-center py-3">
                                        <span class="fw-bold text-dark fs-6">
                                            <?= __('open_table') ?> <i class="fas fa-arrow-right ms-2 text-info arrow-icon"></i>
                                        </span>
                                    </div>
            ...
            <?php else: ?>
                <div class="alert alert-warning shadow-sm rounded-3 p-4 text-center">
                    ...
                    <a href="/default/settings" class="btn btn-info font-weight-bold text-white">
