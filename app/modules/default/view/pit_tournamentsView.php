<style>
    ...
    .tournament-card:hover {
        ...
        border-color: rgba(255, 193, 7, 0.6) !important; /* Pit konseptine uygun sarımtırak vurgu */
    }
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div class="deep-dive-header flex-grow-1">
                    <h2 class="m-0 fw-bold">
                        <i class="fas fa-tools text-warning me-2"></i> Pit Scout - Turnuva Seçimi
                    </h2>
                    <p class="text-white-50 mb-0 mt-1 fs-6">
                        <i class="fas fa-clipboard-list me-1"></i> Takımların fiziksel özelliklerini ve fotoğraflarını gireceğiniz turnuvayı seçin.
                    </p>
                </div>
            </div>
                ...
                <div class="row g-4">
                    <?php foreach ($data['tournaments'] as $event): ?>
                        <div class="col-12 col-md-6 col-xl-4 mb-3">
                            <a href="/default/pit_teams/<?= $event['key'] ?>" class="text-decoration-none text-dark d-block h-100">
                                <div class="card h-100 tournament-card shadow-sm bg-white">
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <div class="mt-auto d-flex justify-content-between align-items-center border-top pt-3">
                                            <span class="badge bg-warning bg-opacity-10 text-dark border border-warning font-monospace fs-6 px-3 py-2">
                                    ...
                                    <div class="card-footer bg-light border-0 text-center py-3">
                                        <span class="fw-bold text-dark fs-6">
                                            Pit Alanına Git <i class="fas fa-arrow-right ms-2 text-warning arrow-icon"></i>
                                        </span>
                                    </div>
